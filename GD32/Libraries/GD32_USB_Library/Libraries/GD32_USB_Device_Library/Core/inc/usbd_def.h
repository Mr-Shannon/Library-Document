/**
  ...
  * @version V1.0.0
  * @date    26-Dec-2014
  * @brief   General defines for the USB OTG_FS device mode
  ******************************************************************************
  */ 
...
/** @defgroup USB_OTG_FS_Device_DEF
  * @{
  */ 

/** @defgroup USB_OTG_FS_DEF_Exported_Defines
  * @{
  */
#ifndef NULL
    #define NULL                                           0
...
#define  USB_FEATURE_ENDP_HALT                          0x00
...
/** @defgroup OTG_FS_USBD_DEF_Exported_Macros
  * @{
  */
