/**
  ******************************************************************************
  * @file    DAC/DAC_ChannelOne_NoiseWave/main.c
  * @author  MCU SD
  * @version V1.0
  * @date    26-Dec-2014
...
void DAC_Configuration(void)
{
    ...
    /* Set DAC channel one C1R12DHR register */
    DAC_SetChannel1Data(DAC_ALIGN_12B_R, 0x7F0);
}

/**
  * @brief  Configures the different TIM2
  * @param  None
  * @retval None
  */
